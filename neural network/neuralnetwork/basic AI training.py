...
#code link:
#https://notebooks.azure.com/goldengrape/projects/deeplearning-ai/html/COURSE%
#201%20Neural%20Networks%20and%20Deep%20Learning/Week%204/Building%20your%20Dee
#p%20Neural%20Network%20-%20Step%20by%20Step/dnn_utils_v2.py
...
#following for from coursera assignment I did 
...
def initialize_parameters(n_x, n_h, n_y):
    ...
    ##choose 0.01 because too large the oupt of the slope of the 
    ##gradient is very small for tanh and sigmoid function, 
    ##therefore the gradient decent would be very small, the learning rate
    ##would be very slow
...
def linear_backward(dZ, cache):
    ...
    db = 1/m*dZ.sum(axis=1).reshape(np.shape(b))
...
fname = "C:/Users/Home/Pictures/" + my_image
